...
def signoff(String useremail, String username, String creds, String url, String pushurl, String branch) {
    new Signoff().call(useremail, username, creds, url, pushurl, branch)
}
